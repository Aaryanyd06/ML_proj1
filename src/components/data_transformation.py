...
class DataTransformationConfig:
    preprocessor_file_path=os.path.join('artefacts', "preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_tansformer_object(self):
        ...
        try:
            ...
            preprocessor=ColumnTransformer(
                [
                    ("num_pipeline", num_pipelline, num_col),
    ...
    def data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            train_arr = np.c_[
                input_train, np.array(target_feature_train)
            ]

            test_arr = np.c_[
                input_test, np.array(target_feature_test)
            ]
